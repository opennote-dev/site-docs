...
We serialize certain data into the URL of a video so you can keep the data together wherever you are displaying the video. Take the below URL for example: 
